...
echo " "
printf "                 \e[1;77m v1.0 coded by github.com/abdrrahmanameur\e[0m \n"
printf "                 \e[1;77m This script by { Abdrrahman Ameur }\e[0m \n"
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] pic taked!\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
